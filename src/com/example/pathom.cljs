...
(def my-resolvers-and-mutations 
  ...
  [#_index-explorer create-random-thing i-fail person])
  ...
  (def attr-errs 
    {:com.wsscode.pathom3.connect.runner/attribute-errors 
     ...
     {:com.wsscode.pathom3.error/cause :com.wsscode.pathom3.error/node-errors, 
      :com.wsscode.pathom3.error/node-error-details {1 {:com.wsscode.pathom3.error/cause :com.wsscode.pathom3.error/node-exception, 
                                                        :com.wsscode.pathom3.error/exception {:message "Fake resolver error", :data {}}}}}})
  
  (-> attr-errs :i-fail :com.wsscode.pathom3.error/node-error-details (get 1) :com.wsscode.pathom3.error/exception :message)
    ...
    {:com.wsscode.pathom3.connect.runner/attribute-errors
     {:com.wsscode.pathom3.connect.runner/attribute-errors
      ...
      {:com.wsscode.pathom3.error/cause :com.wsscode.pathom3.error/node-errors, 
       ...
       {1 {:com.wsscode.pathom3.error/cause :com.wsscode.pathom3.error/node-exception, 
           :com.wsscode.pathom3.error/exception #error {:message "Deu ruim.", :data {}}}}}, 
      
      :com.wsscode.pathom3.connect.runner/mutation-error {:com.wsscode.pathom3.error/cause :com.wsscode.pathom3.error/attribute-unreachable}}})
